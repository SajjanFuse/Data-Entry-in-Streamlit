"""
Just a practice, not complete file
"""
...
# Create a DataFrame with 14 rows
data = pd.DataFrame({
    'ApplicantIncome': np.random.randint(2000, 10000, size=14),  # Random integers between 2000 and 10000
    'LoanAmount': np.random.randint(50, 200, size=14)  # Random integers between 50 and 200
})
